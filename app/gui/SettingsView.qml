...
Flickable {
    ...
    Component.onDestruction: {
        ...
        // deactivating callback if the user just closes Aurora
        StreamingPreferences.save()
    }
        ...
        GroupBox {
            ...
            Column {
                ...
                CheckBox {
                    ...
                    width: parent.width
                    text: qsTr("Mute audio stream when Aurora is not the active window")
                    font.pointSize: 12
                    visible: SystemProperties.hasDesktopEnvironment
                    ...
                    ToolTip.timeout: 5000
                    ToolTip.visible: hovered
                    ToolTip.text: qsTr("Mutes Aurora's audio when you Alt+Tab out of the stream or click on a different window.")
                }
            }
        }
                    ...
                    onActivated : {
                        ...
                        if (StreamingPreferences.language !== new_language) {
                            ...
                            if (!StreamingPreferences.retranslate()) {
                                ToolTip.show(qsTr("You must restart Aurora for this change to take effect"), 5000)
                            }
                            else {
                ...
                Row {
                    ...
                    CheckBox {
                        ...
                        ToolTip.text: qsTr("This enables the capture of system-wide keyboard shortcuts like Alt+Tab that would normally be handled by the client OS while streaming.") + "\n\n" +
                                      qsTr("NOTE: Certain keyboard shortcuts like Ctrl+Alt+Del on Windows cannot be intercepted by any application, including Aurora.")
                    }
        ...
        GroupBox {
            ...
            Column {
                ...
                CheckBox {
                    ...
                    width: parent.width
                    text: qsTr("Process gamepad input when Aurora is in the background")
                    font.pointSize: 12
                    visible: SystemProperties.hasDesktopEnvironment
                    ...
                    ToolTip.timeout: 5000
                    ToolTip.visible: hovered
                    ToolTip.text: qsTr("Allows Aurora to capture gamepad inputs even if it's not the current window in focus")
                }
            }
        }
            ...
            Column {
                ...
                AutoResizingComboBox {
                    ...
                    model: ListModel {
                        ...
                        ListElement {
                            text: qsTr("PyroWave (GPU wavelet)")
