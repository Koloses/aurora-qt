...
ApplicationWindow {
    ...
    // to allow the user to work with Aurora on a second display
    // while dealing with configuration issues. This will ensure
    // machines come online even if the input focus isn't on Aurora.
    Timer {
        id: inactivityTimer
        interval: 5 * 60000
        onTriggered: {
    ...
    header: ToolBar {
        ...
        RowLayout {
            ...
            NavigableToolButton {
                ...
                {
                    ToolTip.text = qsTr("Update available for Aurora: Version %1").arg(version)
    ...
    ErrorMessageDialog {
        ...
        text: qsTr("No functioning hardware accelerated video decoder was detected by Aurora. " +
    ...
    NavigableMessageDialog {
        ...
        text: qsTr("This version of Aurora isn't optimized for your PC. Please download the '%1' version of Aurora for the best streaming performance.").arg(SystemProperties.friendlyNativeArchName)
        onAccepted: {
    ...
    ErrorMessageDialog {
        ...
        text: qsTr("Aurora detected gamepads without a mapping:") + "\n" + unmappedGamepads
        helpTextSeparator: "\n\n"
