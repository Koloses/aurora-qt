...
convert -density 256 -background none -define icon:auto-resize ../app/res/aurora.svg ../app/moonlight.ico
convert -density 256 -background none -size 64x64 ../app/res/aurora.svg ../app/moonlight_wix.png
